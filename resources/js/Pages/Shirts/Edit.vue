...
const updateData = (shirt) => {
    form.band = band.value ? band.value.id : shirt.accessory_band_id;
    form.name = shirt.name;
    form.stock = shirt.stock;
    form.price = shirt.price;
    form.put(route("shirts.update", shirt.id), {
        errorBag: "updateData",
        preserveScroll: true,
        onError: () => {
            if (form.errors.band) {
...
<template>
    <AppLayout title="Shirts">
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <FormSection @submitted="updateData(shirt)">
                <template #title>Edit Shirt</template>

                <template #description> Edit a shirt data. </template>

                <template #form>
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="band" value="Shirt Band" />
                        <div class="dropdown relative mt-2 w-full">
                            ...
                            >
                                {{
                                    band ? band.name : shirt.accessory_band_name
                                }}
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="name" value="Shirt Name" />
                        <TextInput
                            id="name"
                            ref="nameInput"
                            v-model="shirt.name"
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="stock" value="Shirt Stock" />
                        <TextInput
                            id="stock"
                            ref="stockInput"
                            v-model="shirt.stock"
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="price" value="Shirt Price" />
                        <TextInput
                            id="price"
                            ref="priceInput"
                            v-model="shirt.price"
