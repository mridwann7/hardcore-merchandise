...
const onSearch = (search) => {
    location.href = `/shirts?search=${search}`;
};
        ...
        <div class="py-10">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="w-full flex">
                    <div class="w-1/2">
                        <Link :href="route('shirts.create')">
                            <PrimaryButton>Add New Shirt</PrimaryButton>
                        </Link>
                        <Link :href="route('shirts.trashed')">
