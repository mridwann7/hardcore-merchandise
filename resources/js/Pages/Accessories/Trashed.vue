                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <tr
                                                ...
                                                v-if="
                                                    trashed_accessories.length >
                                                    0
                                                "
                                                v-for="trashed_band in trashed_accessories"
                                                :key="trashed_band.id"
                                            >
                                                <td
                                                ...
                                                >
                                                    {{
                                                        trashed_band.accessory_band_name
                                                    }}
                                                </td>
                                                <td
                                                    class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"
                                                >
                                                    Rp. {{ trashed_band.price }}
                                                </td>
                                                <td
                                                    class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"
                                                >
                                                    {{ trashed_band.stock }} PCS
                                                </td>
                                                <td
                                                    class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"
                                                >
