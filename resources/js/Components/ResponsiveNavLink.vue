...
const classes = computed(() => {
    return props.active
        ? "block pl-3 pr-4 py-2 border-l-4 border-zinc-400 text-base font-medium text-zinc-700 bg-zinc-50 focus:outline-none focus:text-zinc-800 focus:bg-zinc-100 focus:border-zinc-700 transition"
